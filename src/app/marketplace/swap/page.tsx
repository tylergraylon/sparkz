    ...
    return (
        <main className="" onClick={() => setClick(swap.HIDDEN)}>
            ...
            >
                ...
                {
                    click === swap.SHOW && <div className={`absolute 
                    -top-10 -left-10 h-[110%] w-[110%] bg-black bg-opacity-60 flex items-center justify-center text-3xl space-x-12`}>
                ...
                <p className="mt-2 font-serrat text-opacity-70 text-textshade">Swap your tokens in a single transaction</p>
                ...
                <p className="text-opacity-70 text-textshade font-serrat mt-7 mb-1">From</p>
               ...
               <SwapTile coin="SPK" img={sparkzswap}/>
                ...
                <button type="button" className="bg-white w-full mt-11 mb-5 font-mono font-semibold p-4 text-black">
                    Continue
                </button>
...
function SwapTile ({coin, img}: {coin: string, img: StaticImageData | string}) {
    return (
